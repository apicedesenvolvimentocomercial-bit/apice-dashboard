...
import { quickAddClinicActivityAction } from '@/domains/clinic/activities/activity-actions'

/**
 * Quick-add de atividade do DOMÍNIO CLÍNICA. Espelha o design do admin
 * (modules/activities/quick-add) mas usa a action de clínica — dados separados.
 */
type Props = {
...
export function ClinicQuickAdd({ assignedToId, folderLabel, activityCalendarSync = 'ASK' }: Props) {
  ...
  function submit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const res = await quickAddClinicActivityAction(title, {
