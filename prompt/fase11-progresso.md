...
> **STATUS GERAL (2026-05-22):** itens 1,2,4,5,6 CONCLUÍDOS e verdes; item 3
> (a11y) concluído, (perf/Lighthouse) documentado p/ prod; item 7 (deploy/domínio)
> com checklist pronto, aguardando ação do usuário. App: tsc 0 · eslint 0 · vitest
> 131 · E2E 11. RLS construída e validada (ver `rls-gambiarra.md`).
...
| 7   | Deploy produção + custom domain                 | CHECKLIST PRONTO (ação do usuário) | S3 (2026-05-22) | [`deploy-checklist.md`](./deploy-checklist.md): env vars, migrations, **rollout da RLS** (criar role restrito + trocar DATABASE_URL), domínio, smoke + Lighthouse. Deploy/domínio em si exige acesso seu ao Vercel + DNS.                                                                                                                                                                                                                  |
