...
const CLINIC_NAME = 'Jean teste'
const CLINIC_SLUG = 'jean'
const OWNER_EMAIL = 'jean@gmail.com'
...
async function main() {
  console.log('🌱 Criando acesso beta de Jean...')
  ...
  const testUsers = [
    { email: 'gerente-jean@senno.dev', name: 'Gerente (teste)', role: 'Gerente' },
    { email: 'atendente-jean@senno.dev', name: 'Atendente (teste)', role: 'Atendente' },
    { email: 'financeiro-jean@senno.dev', name: 'Financeiro (teste)', role: 'Financeiro' },
    { email: 'semcargo-jean@senno.dev', name: 'Sem Cargo (teste)', role: null },
  ] as const
  ...
  console.log('     gerente-jean@senno.dev    (todas as abas + convite + dashboard amplo)')
  console.log('     atendente-jean@senno.dev  (só comercial; dashboard sem no-show)')
  console.log('     financeiro-jean@senno.dev (só financeiro + exportações)')
  console.log('     semcargo-jean@senno.dev   (sem cargo → expulso no login)')
}
